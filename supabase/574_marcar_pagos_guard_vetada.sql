-- 574 - marcar_pagos: RECHAZA dias VETADA (no pagables). Antes un dia vetado se
-- podia sellar PAGADA (gap money-safe). Base = def viva 572 + guard VETADA en el
-- loop de validacion. Sin otros cambios.
