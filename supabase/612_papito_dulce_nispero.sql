...
update mos.adhesivo_plantillas set
  ...
  json = '{
    "capas": [
      ...
      { "id": "tf", "tipo": "icono", "x_mm": 15,   "y_mm": 18.6, "idIcono": "telefono", "tamano_dots": 32 },
      { "id": "t4", "tipo": "texto", "x_mm": 19.8, "y_mm": 19.2, "texto": "972 225 28", "font": 3, "negrita": false, "rotacion": 0, "alineacion": "left" }
    ],
