...
- ⬜ **PENDIENTE (ports grandes, solo-impresión/fiscal/IA — NO money-mutantes)**: item **13** impresión Z-cierre (462 líneas ESC/POS, ALTA frecuencia) + pago (175) + cargadores(sin caller) → Edge imprimir, verificar en impresora real · **10** Tributación×6 · **11** OCR/Jefa×6 (Edge ia/vision) · **12/23/27** espía chunks (Storage+Edge) · **20-22** ME etiquetas/impresora · **29** ExtensorHorario · **1-resto** notif probar/reenviar (push) · **32** portales cliente (BLOQUEADO: export Sheet del dueño) · **33** turno.html.
