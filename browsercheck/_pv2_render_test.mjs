...
t('almacén marca el faltante', /falta 2\.938 kg|falta 2\.94 kg/.test(out.cuadros));
...
t('muestra la salida semanal', out.cover.includes('sale 27.238 kg/sem') || /sale 27\.2\d* kg\/sem/.test(out.cover));
...
t('llamado a la acción = COMPRAR', out.ovlAlm.includes('se le compra al proveedor'));
