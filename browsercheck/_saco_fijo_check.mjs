...
t('[633] toggles 100% independientes (GO no toca estado en ninguna dirección)',
  app.includes('INDEPENDENCIA TOTAL') && !app.includes("if (on && !_isProdActivo(p)) { p.estado = '1'") && !app.includes('lo APAGA en el catálogo (ME)'));
